...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_NRF_CHAR_RW2 = UUID.fromString("6e400002-b5a3-f393-e0a9-e50e24dcca9e"); // read on Micro:bit, write on adafruit
    ...
    private void onPairingBroadcastReceive(Context context, Intent intent) {
        // for ARM Mbed, Micro:bit, ... use pairing from Android bluetooth settings
    ...
    private void connectCharacteristics3(BluetoothGatt gatt) {
        ...
        if ((writeProperties & (BluetoothGattCharacteristic.PROPERTY_WRITE +     // Micro:bit,HM10-clone have WRITE
